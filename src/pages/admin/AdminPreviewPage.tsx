  ...
  return (
    <main className={`admin-shell${busy ? ' is-busy' : ''}`}>
      ...
      <section className="admin-workspace">
        ...
        {tab === 'visitas' && (
          <AdminVisitsSection ctx={{ visits, loading, config, tab, run, refresh }} />
        )}
        ...
        {tab === 'soporte' && (() => {
          const TICKET_TYPES: Record<string, string> = { bug: 'Error en la app', question: 'Consulta', payment_issue: 'Problema con pago', suggestion: 'Sugerencia', other: 'Otro' };
          const TICKET_STATUS: Record<string, string> = { open: 'Abierto', in_progress: 'En proceso', resolved: 'Resuelto', closed: 'Cerrado' };
